...
//The logic is simple, if index of the partitioned element is more than k, then we recur for the left part. If index is the same as k, we have found the k-th smallest element and we return. 
//If index is less than k, then we recur for the right part

//TC: O(N) in average case ----> that is why is is sort of an optimisation to using HEAPS to find kth smallest or greatest element in an array.
// O(N ^ 2) -----> worst case
